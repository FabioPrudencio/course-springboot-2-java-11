package com.ornitorrincosystems.coursespring.config;
...
import com.ornitorrincosystems.coursespring.entities.Payment;
...
import com.ornitorrincosystems.coursespring.services.UserService;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		orderService.saveAll(Arrays.asList(o1));
